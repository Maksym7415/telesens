...
const RootPage = (props) => {
  ...
  const [subCat, setSubCat] = useState(22)
  ...
  } /* here in changeSubCat() I'm cheking parentCatId for existance of contentCatId,
  because category 'Для детей' haven't it */
  ...
  return (
    <div className='root-page'>
      ...
      <h3>
        Content from:
        <span>{current && subCat ? `${catSubCatName(props.data, current)}/${catSubCatName(props.data, subCat)}` : ''}</span>
      </h3>
